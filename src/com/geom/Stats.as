...
package com.geom {
	...
	public class Stats extends Sprite {	
		...
		protected const WIDTH : uint = 300;
		protected const HEIGHT : uint = 200;
		...
		public function Stats() : void {
			...
			style.setStyle('xml', {fontSize:'14px', fontFamily:'_sans', leading:'-2px'});
		...
		private function init(e : Event) : void {
			...
			graph = new BitmapData( WIDTH , HEIGHT - 50 , true , colors.bg );
		...
		private function update(e : Event) : void {
			...
			if( timer - 1000 > ms_prev ) {
				...
				xml.fps = "FPS: " + fps + " / " + stage.frameRate ;// + " W: " + stage.width + " H: " + stage.height + " SW: " + stage.stageWidth + " SH: " + stage.stageHeight  ; 
				xml.mem = "MEM: " + mem;
